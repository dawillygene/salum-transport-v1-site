...
<section class="page-title page-title-1" id="page-title">
  <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
    <div class="bg-section">
      <img src="assets/images/page-titles/4.jpg" alt="Salum Transport Background" />
    </div>
    <div class="container">
      <div class="row">
    ...
    <div class="row">
      <div class="col-12 col-lg-5">
        <div class="about-img">
          <div class="about-img-holder bg-overlay">
            <div class="bg-section">
              <img src="assets/images/about/10.jpg" alt="About Salum Transport" />
            </div>
          </div>
          <div>
            <div class="counter">
      ...
      <div class="col-12 col-lg-7">
        <div class="heading heading-1">
          <p class="heading-subtitle heading-subtitle-bg">Leading in Fuel Sales & Transportation Services</p>
          <h2 class="heading-title">We Are Experts in Fuel Distribution & Transportation Across Zanzibar</h2>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-5">
              <div class="block-right">
                <div class="prief-set">
                  <p>How do we provide reliable fuel and transportation services while ensuring customer satisfaction?</p>
                  <ul class="list-unstyled advantages-list">
                    <li>Timely fuel deliveries</li>
                    <li>Reliable transportation for staff and materials</li>
                    <li>Competitive pricing on fuel sales</li>
                  </ul>
                </div>
              </div>
            </div>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
  <div class="bg-section"> 
    <img src="assets/images/background/salum-transport.jpg" alt="Salum Transport Background" />
  </div>
  <div class="container">
    <div class="heading heading-2 heading-light heading-light2">
      <div class="row">
        <div class="col-12 col-lg-5">
          <p class="heading-subtitle">Reliable & Efficient Transportation Services</p>
        </div>
      </div>
      <div class="row">
        <div class="col-12 col-lg-5">
          <h2 class="heading-title">Delivering Value Through Expertise & Commitment</h2>
        </div>
    ...
    <div class="carousel owl-carousel carousel-dots" data-slide="4" data-slide-rs="2" data-autoplay="true" data-nav="false" data-dots="true" data-space="25" data-loop="true" data-speed="800">
      ...
      <div>
        <div class="feature-panel-holder">
          <div class="feature-panel">
            <div class="feature-icon">
              <i class="flaticon-026-construction"></i>
            </div>
            <div class="feature-content">
      ...
      <div>
        <div class="feature-panel-holder">
          <div class="feature-panel">
            <div class="feature-icon">
              <i class="flaticon-008-support"></i>
            </div>
            <div class="feature-content">
    ...
    <div class="row">
      ...
      <!-- <div class="col-12 col-lg-8">
        <div class="video video-1 bg-overlay bg-overlay-video" id="video-1">
          <div class="bg-section">
            <img src="assets/images/video/salum-transport.jpg" alt="Watch Our Video" />
          </div>
          <a class="popup-video btn-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4">
            <i class="fas fa-play"></i><span>Watch Our Services!</span>
          </a>
        </div>
      </div> -->
    </div>
