            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="footer-widget widget-contact">
                  <div class="widget-content">
                    <ul> 
                      <li class="phone">+255<a href="tel:+01061245741">777 416 880</a></li>
                      <li class="email">Email: <a href="mailto:info@salumtransports.co.tz">info@salumtransports.co.tz</a></li>
                      <li class="address">
                        <p>Mwera Kigorofani,ZANZIBAR</p>
                      </li>
            ...
            <div class="row">
              <div class="col-12">
                <div class="footer-copyright">
                  <div class="copyright"><span>&copy; 2024<a href="https://salumtransports.co.tz"> salumtransport company Ltd</a>. all rights reserved. </span>
